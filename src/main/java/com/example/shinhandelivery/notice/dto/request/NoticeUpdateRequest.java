...
public class NoticeUpdateRequest {
  ...
  @Schema(description = "공지사항 제목", example = "[변경] 서비스 정기 점검 안내")
  @NotBlank(message = "공지사항 제목은 필수입니다.")
  @Size(max = 150, message = "공지사항 제목은 150자 이하여야 합니다.")
  private String title;

  @Schema(description = "공지사항 본문", example = "변경된 점검 일정을 안내드립니다.")
  ...
  public static NoticeUpdateRequest of(
      String title, String content, String category, Boolean isPinned) {
    return new NoticeUpdateRequest(title, content, category, isPinned);
  }
}
