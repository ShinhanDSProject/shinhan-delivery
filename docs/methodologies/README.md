...
이 가이드북은 `shinhan-delivery` 프로젝트 팀원 및 입문자가 **도메인 설계, 테스트 기법, 애자일 협업, AI 활용 개발 및 보안 방어 수칙**을 체계적으로 익히고 실무에 즉시 적용할 수 있도록 정리된 **14대 현대 소프트웨어 개발 방법론 총서**입니다.
