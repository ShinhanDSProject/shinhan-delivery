...
metadata:
  version: "1.0.0"
  ssot_owner: "docs/methodologies/xp.md"
...
이 문서는 `shinhan-gaecheokja` 프로젝트에서 **코드 품질과 엔지니어링 실천법(Engineering Practices)을 극대화하여 기술적 부채를 차단하는 XP(익스트림 프로그래밍)** 방법론의 가이드북입니다.
