...
metadata:
  version: "1.0.0"
  ssot_owner: "docs/methodologies/migration-driven-development.md"
...
이 문서는 `shinhan-gaecheokja` 프로젝트에서 **DB DDL 조작을 직접 수행하지 않고, 버전 관리된 마이그레이션 스크립트와 무중단 Online DDL 규격을 사수하는 마이그레이션 주도 DB 개발** 방법론의 가이드북입니다.
