...
metadata:
  version: "1.0.0"
  ssot_owner: "docs/methodologies/다층-방어-보안.md"
...
- [보안 & JWT 인증 가이드 (docs/architecture/보안-및-JWT-가이드.md)](../보안-및-JWT-가이드.md)
- [ADR-0001: JWT 기반 무상태 인증 체계 채택 (docs/adr/0001-무상태-JWT-인증-체계.md)](../adr/0001-무상태-JWT-인증-체계.md)
