...
metadata:
  version: "1.0.0"
  ssot_owner: "docs/methodologies/atdd.md"
...
이 문서는 `shinhan-gaecheokja` 프로젝트에서 **사용자 인수 조건(Acceptance Criteria)을 엔드투엔드(E2E) 자동화 인수 테스트로 작성하여 개발을 인도하는 ATDD** 방법론의 가이드북입니다.
