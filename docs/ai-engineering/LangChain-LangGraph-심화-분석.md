...
metadata:
  version: "1.1.0"
  ssot_owner: "docs/ai-engineering/LangChain-LangGraph-심화-분석.md"
...
이 문서는 `shinhan-delivery` 프로젝트 개발진을 위해 **LangChain과 LangGraph 각 도구의 기본 개념, 주요 기능, 실무 쓰임새 및 우리 프로젝트의 구현 사례**를 체계적으로 정리한 전문 가이드북입니다.
