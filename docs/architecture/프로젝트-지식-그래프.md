...
graph TD
    ...
    subgraph KnowledgeDocs ["📚 주제별 문서 자산 (Docs)"]
        Doc_Harness["docs/harness/테스트-하네스-판단-및-통제-정책.md"]
        Doc_GraphArch["docs/ai-engineering/그래프-엔지니어링-아키텍처.md"]
        Doc_DeliveryState["docs/design/배송-상태-전이도.md"]
        Doc_Risk["docs/onboarding/사전-리스크-감사-및-거버넌스-가이드.md"]
    end
...
- `./scripts/verify.sh` 및 5대 린터:
  - 🛡️ [**테스트 하네스 구축 및 6대 통제 정책 가이드 (docs/harness/테스트-하네스-판단-및-통제-정책.md)**](./테스트-하네스-판단-및-통제-정책.md)
  - 🤖 [**LLM 소프트웨어 엔지니어링 방법론 가이드 (docs/ai-engineering/LLM-소프트웨어-엔지니어링-가이드.md)**](./LLM-소프트웨어-엔지니어링-가이드.md)
