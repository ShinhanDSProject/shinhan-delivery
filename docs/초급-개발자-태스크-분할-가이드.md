...
metadata:
  version: "1.0.0"
  ssot_owner: "docs/초급-개발자-태스크-분할-가이드.md"
...
> [!NOTE]
> 본 가이드북은 [docs/SSOT-문서화-정책-가이드.md](./SSOT-문서화-정책-가이드.md) 전문 기술 문서화 표준 규격과 [code-convention.md](../code-convention.md) 코딩 수칙을 준수합니다.
...
* 참조 가이드: [docs/REST-API-설계-규격-가이드.md](./REST-API-설계-규격-가이드.md)
...
* 참조 가이드: [docs/전역-예외-처리-규격-가이드.md](./전역-예외-처리-규격-가이드.md)
...
* 참조 가이드: [docs/PR-리뷰어-3분-족보-가이드.md](./PR-리뷰어-3분-족보-가이드.md)
...
* [테스트 하네스 가이드 (docs/테스트-하네스-및-LLM-가이드.md)](./테스트-하네스-및-LLM-가이드.md)
```
