...
* **연관 이슈 (Related Issue):** [Issue #70](https://github.com/ShinhanDSProject/shinhan-gaecheokja/issues/70)
* **연관 PR (Related PR):** [PR #84](https://github.com/ShinhanDSProject/shinhan-gaecheokja/pull/84)

---

## 📌 1. 배경 및 문제 제기 (Context & Problem Statement)

`shinhan-gaecheokja` 프로젝트는 고객, 배달원(쿠리어), 관리자가 실시간으로 배송 및 차량, 결제 데이터를 주고받는 대용량 RESTful API 서비스입니다.
