...
metadata:
  version: "1.0.0"
  ssot_owner: "docs/onboarding/AI-기반-페어-프로그래밍-가이드.md"
...
> [!NOTE]
> 본 가이드북은 [docs/architecture/SSOT-문서화-정책-가이드.md](./SSOT-문서화-정책-가이드.md) 단일 원본 원칙과 [docs/beginners/초급자-CRUD-이슈-템플릿-가이드.md](./초급자-CRUD-이슈-템플릿-가이드.md) 초급자 CRUD 가이드를 100% 반영합니다.
