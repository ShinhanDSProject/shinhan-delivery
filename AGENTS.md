...
* **UI 개발 시 React/타 프레임워크 도입을 엄격히 금지하며, 반드시 공통 디자인 시스템(`/css/design-system.css`, `docs/design-system.md`) 토큰과 Thymeleaf 프래그먼트(`templates/fragments/components.html`)를 100% 사용하여 개발해야 합니다.**
